           ...
           {                                                                
               ...
               token : sessionToken,
                                    ...
                                    success: function(data)
                                    {
                                                                                       ...
                                                                                       console.log("getDelegResp"+JSON.stringify(data));
                                                                        ...
                                                                        if ((delegations[i].userDelegated !="ANONYMOUS")&&(delegations[i].userDelegated!=null)) {
                                                                               console.log("adding user delegation"+ delegations[i].delegationId);
                                                                               ...
                                                                               console.log("adding user delegation"+JSON.stringify(delegations[i]));
							...
							console.log($(this).parents('tr').attr('data-delegationId'));
                                                        ...
                                                        error: function(errorData)
                                                        {
                                                           //TBD  insert a message of error
                                                                              ...
                                                                              $('#delegationsTableGroup tbody').on("click","i.removeDelegationBtnGroup",function(){
                                                                                                       console.log("toremove:"+$(this).parents('tr').attr('data-delegated'));
                                                                                                       var rowToRemove = $(this).parents('tr');
                                                                                                       $.ajax({
                                                                                                               url: "../api/device.php",     //check the url
                                                                                                               data:
               ...
               var newDelegation = document.getElementById('newDelegation').value;
                ...
                $.ajax({
                                                        ...
                                                        success: function(data)
                                                        {
                                                                if (data["status"] === 'ok')
                                                               {
									console.log("risposta alla insert:"+JSON.stringify(data));
