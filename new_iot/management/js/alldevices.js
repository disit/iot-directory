...
//GET PARAM VALUES 
	...
	(attrName, data_type, value_type, editable, value_unit, healthiness_criteria, value_refresh_rate,old_value_name, parent)
	{
		...
		if (attrName=="")
			msg="<div style=\"color:red;\" class=\"modalFieldMsgCnt\">Value name is mandatory</div>";
		else 
			   ...
			   console.log("Marco edit Data " + data);
				...
				if(data["status"] === 'ko')
				{
					...
					setTimeout(function(){
						...
						$('#editDeviceKoMsg div:first-child').html(data["msg"]);
						//$('#editDeviceModalFooter').show();
					}, 3000);
				}
				...
				else if (data["status"] === 'ok')
				{
					...
					//$("#addingDeviceModalInnerDiv1").html('Device &nbsp; successfully Updated');
