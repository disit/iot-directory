							...
							/* must have it later		showEditDeviceModal(); */
								  ...
								  /*
                                        ...
                                        data: {
												...
												contextbroker: $(this).parents('tr').attr("data-cb"),
												device: $(this).parents('tr').attr("data-device"),
												value_name: $(this).parents('tr').attr("data-value_name")
												},
                                        type: "GET",
                                        async: true,
                                        dataType: 'json',
                                           ...
                                           if(mydata["status"] === 'ok')
                                        {
                                            ...
                                            $('#selectContextBrokerM').val(data.valueData.cb);
                                            $('#inputNameDeviceM').val(data.valueData.device);
                                            $('#inputValueNameDeviceM').val(data.valueData.value_name);
                                            $('#selectDataTypeM').val(data.valueData.data_type);
                                            $('#selectValueTypeM').val(data.valueData.value_type);
                                            $('#inputEditableValueM').val(data.valueData.editable);
                                            $('#selectValueUnitM').val(data.valueData.value_unit);
                                            $('#selectHealthinessCriteriaM').val(data.valueData.healthiness_criteria);
                                            $('#inputHealthinessValueM').val(data.valueData.value_refresh_rate);
											$('#inputOrderM').val(data.valueData.order);
                                        ...
                                        {
                                           console.log("Error ajax in retrieving attributes");
                                            console.log(JSON.stringify(mydata));
                                        }
                                    });
