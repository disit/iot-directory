                            ...
                            <div class="row">
                                <div class="col-xs-12 col-md-6 modalCell">
                                    <div class="modalFieldCnt">
                                        <input type="text" class="modalInputTxt" name="inputNameModel" id="inputNameModel" required> 
                                    </div>
                    ...
                    <div class="tab-content">
                        ...
                        <div id="editInfoTabModel" class="tab-pane fade in active">
						 ...
						 <div class="row">
                                <div class="col-xs-12 col-md-6 modalCell">
                                    <div class="modalFieldCnt">
                                        <input type="text" class="modalInputTxt" name="inputNameModelM" id="inputNameModelM" required> 
                                    </div>
                                    <div class="modalFieldLabelCnt">Name</div>
