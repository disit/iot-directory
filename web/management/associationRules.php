                    ...
                    <div class="col-xs-12" id="mainContentCnt">
                        ...
                        <div id="managerBoard" class="row mainContentRow">
                            <div id="uploadFileBoard" class="row mainContentRow">
                                ...
                                <div class="col-xs-12 mainContentCellCntWhiteLines">
                                    <div class="col-xs-12 col-md-6 ">
                                        <div class="paddingTop">Frequency of searching for new devices</div>
                                    </div>
                                    <div class="col-xs-12 col-md-6 ">

                                        <div class=" col-xs-12 col-md-4">Hours:
                                            <select id="selectorHours" style="margin-left: 5px;">
                                                <?php
                                                for ($i = 0; $i <= 24; $i++) {
                                                ?>
                                        ...
                                        <div class=" col-xs-12 col-md-4">Minutes:
                                            <select id="selectorMinutes" style="margin-left: 5px;">
                                                <?php
                                                for ($i = 0; $i <= 59; $i++) {
                                                ?>
                                                    <option value="<?php echo $i; ?>"><?php echo $i; ?></option>
                                        ...
                                        <div class=" col-xs-12 col-md-4">Seconds:
                                            <select id="selectorSeconds" style="margin-left: 5px;">
                                                <?php
                                                for ($i = 1; $i <= 59; $i++) {
                                                    if ($i == 25) {
                                                        ?>
                                ...
                                <div class="uploadBulkLoad pull-left">
                                    <button type="text" id="suggestionsButton" name="suggestionsButton" class="btn btn-info" style="margin-left: 10px;">Suggest Modifications</button>
                                </div>
                            ...
                            <div id="displayAllDeviceRow" class="row mainContentRow">
                                ...
                                <div class="col-xs-12 mainContentCellCnt">
                                    ...
                                    <button type="text" id="insertValidAttributeBtn" name="myDevice" class="btn btn-primary pull-right">Insert Valid Parameters</button>
                                </div>
                            </div>
                        </div>
                    </div>
