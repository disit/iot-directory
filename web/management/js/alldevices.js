...
function drawAttributeMenu(attrName, data_type, value_type, editable, value_unit, healthiness_criteria, value_refresh_rate, old_value_name, parent, indice) {
    ...
    return "<div class=\"row\" style=\"border:2px solid blue;\" id=\"value" + indice + "\">" +
            ...
            "<div class=\"modalFieldCnt\" title=\"Insert a name for the sensor/actuator\"><input type=\"text\" class=\"modalInputTxt Input_onlyread\"" +
            ...
            "<select class=\"modalInputTxt Select_onlyread\" name=\"" + attrName + "-type" +
            ...
            "</select></div><div class=\"modalFieldLabelCnt Hidden_insert\">Healthiness Criteria</div> <input type=\"checkbox\" onclick=\"disableInput(id)\" id=\"Checkbox_" + attrName + "\" checked> <span id=\"SpanCheckbox_" + attrName + "\" class=\" slider round\">Send value</span></label></div>" +
            ...
            "</select></div></div>" +
            "<div class=\"col-xs-6 col-md-3 modalCell\"><div class=\"modalFieldCnt\">" +
            "<button  class=\"btn btn-danger RemoveAttrEdit\" onclick=\"removeElementAt('" + parent + "',this); return true;\">Remove Value</button></div></div></div>";
}
...
$(document).ready(function () {
    ...
    $('#addNewDeviceConfirmBtn').click(function () {
        ...
        for (var m = 0; m < num1; m++) {
            var newatt = {
                value_name: document.getElementById('addlistAttributes').childNodes[m].childNodes[0].childNodes[0].childNodes[0].value.trim(),
            ...
            if (newatt.value_name != "" && newatt.data_type != "" && newatt.value_type != "" && newatt.editable != "" && newatt.healthiness_criteria != "" && newatt.healthiness_value != "")
