...
function getFrequency() {
	var seconds = parseInt($("#selectorSeconds option:selected").text(), 10) * 1000;
	var minutes = parseInt($("#selectorMinutes option:selected").text(), 10) * 60 * 1000;
	var hours = parseInt($("#selectorHours option:selected").text(), 10) * 60 * 60 * 1000;
	...
	dataTable2 = $('#registeredDevicesTable').DataTable({
		...
		"columns": [
			...
			},
			{
				...
				render: function (d) {
					var device = ""
					if (d.service != null && d.servicePath != null) device = d.service + '.' + d.servicePath + '.' + d.device;
					else if (d.service != null && d.servicePath == null) device = d.service + './.' + d.device;
					else device = d.device;
