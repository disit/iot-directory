...
openssl ca -batch -config client.cnf -days 365 -extensions v3_ca_has_san -out certsdb/$2-crt.pem -keyfile private/ca-key.pem -passin pass:$IOTDIR_CA_PASSWORD -cert ca-crt.pem -infiles certreqs/$2-csr.pem 
