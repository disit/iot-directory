...
<head>
    ...
    <!-- Custom scripts -->
    <script type="text/javascript" src="js/extractionRules.js"></script>
    <script type="text/javascript" src="js/rulesManagement.js"></script>
    <script type="text/javascript" src="js/rulesEditManagement.js"></script>
                                            ...
                                            <div id="addInfoTabDevice" class="tab-pane fade in active">
                                                ...
                                                <div class="row" hidden>
                                                    ...
                                                    <div class="col-xs-12 col-md-6 modalCell">
                                                        ...
                                                        <div class="modalFieldLabelCnt">Broker Format</div>
                                                        <div id="selectFormatDeviceMsg" class="modalFieldMsgCnt">&nbsp;</div>
                                                    </div>
                                                    <div class="col-xs-12 col-md-6 modalCell">
                                                        <div id="externalContextBrokerMsg" class="modalFieldMsgCnt"></div>
                                                    </div>
                                                ...
                                                <div class="row" style=" border: 1px solid grey;  border-radius: 5px; padding-bottom:10px; margin-top:5px;">

                                                    <div class="col-xs-12 col-md-6 modalCell">
                                                        <div class="row">
                                                            <div class="modalFieldLabelCnt" style="color:blue">Selector</div>
                                                            <div id="selectorMessage" class="modalFieldMsgCnt">&nbsp;</div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="modalFieldCnt">
                                                                <input type="text" class="modalInputTxt" name="inputSelector" id="parameterName">
                                                            </div>
                                                            <div class="modalFieldLabelCnt">Parameter path</div>
                                                        </div>
                                                    ...
                                                    <div class="col-xs-12 col-md-6 modalCell">
                                                        <div class="row">
                                                            <div class="modalFieldCnt">
                                                                <select id="selectorFormat" name="inputFormat" class="inputFormat">
                                                                    <option value="json">json</option>
                                                                    <option value="xml">xml</option>
                                                                    <option value="csv">csv</option>
                                                                </select>
                                                            </div>
                                                            <div class="modalFieldLabelCnt">Selector Format</div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="modalFieldCnt">
                                                                <select id="selectorNumber">
                                                                    <?php
                                                                    for ($i = 0; $i <= 100; $i++) {
                                                                    ?>
                                                            ...
                                                            <div class="modalFieldLabelCnt">Number of element to extract (0 equals to all)</div>
                                                        </div>
                                    ...
                                    <table id="devicesTable" class="table" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-cellTitle="service">Service</th>
                                                <th data-cellTitle="servicepath">ServicePath</th>
                            ...
                            <div id="editInfoTabDevice" class="tab-pane fade in active">
                                ...
                                <div class="row" style=" border: 1px solid grey;  border-radius: 5px; padding-bottom:10px; margin-top:5px;">
                                    ...
                                    <div class="col-xs-12 col-md-6 modalCell">
                                        <div class="row">
                                            <div class="modalFieldLabelCnt" style="color:blue">Selector</div>
                                            <div id="selectorMessageM" class="modalFieldMsgCnt">&nbsp;</div>
                                        </div>
                                        <div class="row">
                                            <div class="modalFieldCnt">
                                                <input type="text" class="modalInputTxt" name="inputSelector" id="parameterNameM">
                                            </div>
                                            <div class="modalFieldLabelCnt">Parameter path</div>
                                        </div>
                                    ...
                                    <div class="col-xs-12 col-md-6 modalCell">
                                        <div class="row">
                                            <div class="modalFieldCnt">
                                                <select id="selectorFormatM" name="inputFormat" class="inputFormat">
                                                    <option value="json">json</option>
                                                    <option value="xml">xml</option>
                                                    <option value="csv">csv</option>
                                                </select>
                                ...
                                <div class="row" hidden>
                                    <div class="col-xs-12 col-md-6 modalCell">
                                        <div class="modalFieldCnt">
                                            <input type="text" class="modalInputTxt" name="inputSelector" id="inputSelectorM">
                                        </div>
                                        <div class="modalFieldLabelCnt">Selector</div>
                                        <div id="inputSelectorMsg" class="modalFieldMsgCnt">&nbsp;</div>
                                    </div>
                                    ...
                                    <div class="col-xs-12 col-md-6 modalCell">
                                        <div class="modalFieldCnt">
                                            <select id="inputFormatM" name="inputFormat" class="modalInputTxt">
                                                <option value="json">json</option>
                                                <option value="xml">xml</option>
                                                <option value="csv">csv</option>
                                            </select>
