...
<html>
    ...
    <head>
        ...
        <!-- Custom scripts -->
        <script type="text/javascript" src="../legacy/management/js/model.js"></script>
        <script type="text/javascript" src="../legacy/management/js/modelManagement.js"></script>
        <script type="text/javascript" src="../legacy/management/js/modelEditManagement.js"></script>
                                        ...
                                        <table id="modelTable" class="table table-bordered table-striped " cellspacing="0" width="100%">
                                            <thead style="background: rgb(0, 162, 211); color: rgb(255, 255, 255); font-size: 1em;">
                                                <tr>
                                                    ...
                                                    <th data-cellTitle="view">View</th>
                                                </tr>
                                            </thead>
                                        </table>
                                    </div>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modalHeader centerWithFlex">
                         <label id='addModelModalLabel'> </label>
                    ...
                    <div id="addModelModalBody" class="modal-body modalBody">
                        ...
                        <div class="modalFieldCnt"  >
                            ...
                            <select id="selectModel" name="selectModel" class="modalInputTxt"  onclick="CloneModel()">
                                <?php
                                $query = "SELECT name FROM iotdb.model;";
                                $result = mysqli_query($link, $query);
        ...
        <div class="modal fade" id="deleteModelModal" tabindex="-1" role="dialog" aria-labelledby="deleteModelModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div id="deleteModelModalInnerDiv1" class="modalBodyInnerDiv" style="display: none;">
                        <h5>Model deletion in progress, please wait</h5>
                    </div>
