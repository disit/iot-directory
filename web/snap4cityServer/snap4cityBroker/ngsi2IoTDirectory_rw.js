...
const { manageExtractionRulesAtt, manageExtractionRulesDev, verifyDevice, getLocation, manageOtherParameters } = require('./Functions/manageData.js')
...
function storeDevice(user, deviceID, model, kind, type, protocol, frequency, format, cb, latitude, longitude, macaddress, status, validity_msg, shouldberegistered, organization, edge_type, edge_uri, k1, k2, subnature, staticAttributes, producer) {
	return [user, deviceID, model, kind, type, protocol, frequency, format, cb, latitude, longitude, macaddress, status, validity_msg, shouldberegistered, organization, edge_type, edge_uri, k1, k2, subnature, staticAttributes, producer];
}
