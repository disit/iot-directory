...
if ($action == "get_temporary_devices") {
	...
	if (!empty($missingParams)) {
		...
		$r = create_datatable_data($link, $_REQUEST, $q, "deleted IS null AND username = '$username' AND organization='$organization' AND should_be_registered='$should_be_registered' AND (toDelete IS NULL OR toDelete != 'yes')");
