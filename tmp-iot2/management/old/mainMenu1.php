<div class="hidden-xs hidden-sm col-md-2" id="mainMenuCnt">
    <div id="headerClaimCnt" class="col-md-12 centerWithFlex">Snap4City IoT Directory</div>
    ...
    ?> 
    <a href="../management/devices.php" id="dashboardsLink" class="internalLink moduleLink">
        <div class="col-md-12 mainMenuItemCnt">
