   ...
   if(isset($_SESSION['loggedRole']))
   {
       if($_SESSION['loggedRole'] == "ToolAdmin")
       {
          switch($_REQUEST['operation'])
          {
             ...
             case "updateDevice":
               $deviceJson = json_decode($_REQUEST['deviceJson']);
               $inputNameDevice = mysqli_real_escape_string($link, $deviceJson->inputNameDevice); 
			   $inputTypeDevice = mysqli_real_escape_string($link, $deviceJson->inputTypeDevice);
			   $selectContextBroker = mysqli_real_escape_string($link, $deviceJson->selectContextBroker);
			   $inputUriDevice = mysqli_real_escape_string($link, $deviceJson->inputUriDevice);
			   $selectProtocolDevice = mysqli_real_escape_string($link, $deviceJson->selectProtocolDevice);
			   $selectFormatDevice = mysqli_real_escape_string($link, $deviceJson->selectFormatDevice);
			   $createdDateDeviceM = mysqli_real_escape_string($link, $deviceJson->createdDateDeviceM);
			   $inputMacDevice = mysqli_real_escape_string($link, $deviceJson->inputMacDevice);
			   $inputModelDevice = mysqli_real_escape_string($link, $deviceJson->inputModelDevice);
			   $inputProducerDevice = mysqli_real_escape_string($link, $deviceJson->inputProducerDevice);
			   $inputLatitudeDevice = mysqli_real_escape_string($link, $deviceJson->inputLatitudeDevice);
			   $inputLongitudeDevice = mysqli_real_escape_string($link, $deviceJson->inputLongitudeDevice);
			   $inputPropertiesDevice = mysqli_real_escape_string($link, $deviceJson->inputPropertiesDevice);
			   $inputAttributesDevice = mysqli_real_escape_string($link, $deviceJson->inputAttributesDevice);
		 ...
		 $query = "UPDATE iotdirectorydb.devices SET name='$inputNameDevice', type='$inputTypeDevice', contextBroker='$selectContextBroker', uri='$inputUriDevice', protocol='$selectProtocolDevice', format='$selectFormatDevice', 
		 created='$createdDateDeviceM', macaddress='$inputMacDevice', model='$inputModelDevice', producer='$inputProducerDevice', latitude='$inputLatitudeDevice', longitude='$inputLongitudeDevice', properties='$inputPropertiesDevice', attributes='$inputAttributesDevice' WHERE name='$inputNameDevice'";
