		...
		<div class="container-fluid">
            ...
            <div class="row mainRow">
                ...
                <div class="col-xs-12 col-md-10" id="mainCnt">
                    ...
                    <div class="row">
                        <div class="col-xs-10 col-md-12 centerWithFlex" id="headerTitleCnt">Update Bulk Device</div>
						...
						<!--
                            <div class="row hidden-xs hidden-sm mainContentRow">
                               <div class="row mainContentRow">
								...
								<table id="orders-table" data-search="false" data-striped="false" data-pagination="true" data-filter-control="true" data-side-pagination="client" data-page-size="10" data-page-list="[10, 25, 50, 100, ALL]">
									<thead>
										<tr>
											<th data-field="name" data-halign="left" data-align="right" data-filter-control="input">Name</th>
											<th data-field="protocol" data-filter-control="select">Protocol</th>
											
										</tr>
									</thead>
								
                                    <table id="searchevicesTable" class="table"></table>
                                </div>
                            </div>
							...
							-->
				         <div class="row mainContentRow">
                                <div class="col-xs-12 mainContentRowDesc">Search and Update</div>
                                <div class="col-xs-12 mainContentCellCnt">
...
<script type='text/javascript'>
    ...
    $(document).ready(function () 
    {
                    ...
                    $('#devicesTable').bootstrapTable({
                            ...
                            onPostBody: function()
                            {
                                if(tableFirstLoad)
                                {
                                    ...
                                    var addDeviceDiv = $('<div class="pull-right"><i id="addDeviceBtn" data-toggle="modal" data-target="" class="fa fa-exchange" style="font-size:36px; color: #ffffff; background-color: #ffcc00"></i></div>');
		...
		/* To Select all the item in different pages*/
		
		$("#devicesTable").click(function () {
		if($('#btSelectAll').is(":checked")){
			$(".bs-checkbox").prop("checked", "true");
		}
		else {
			$(".bs-checkbox").removeAttr('checked');
		}
	});
