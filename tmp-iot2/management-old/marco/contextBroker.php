	...
	xhr.addEventListener("readystatechange", function () {
	  if (this.readyState === 4 && this.status == 200) {
		console.log(this.responseText);
                // Elf, pleasecan you change the color of the botton in green and deactivate it
    ...
    $(document).ready(function () 
    {
		...
		function buildMainTable(destroyOld)
        {
            ...
            $.ajax({
                    ...
                    $('#contextBrokerTable').bootstrapTable({
						...
						*/
                        ...
                        },
						{
                            ...
                            formatter: function(value, row, index)
                            {
                                return '<button type="button" class="viewDashBtn">Stub</button>';
                            },
                            cellStyle: function(value, row, index, field) {
                                if(index%2 !== 0)
                                {
				...
				activateStub(name,ip,port,protocol);
				//****************************************************
                            });
