		...
		if($r) 
		{
           while($row = mysqli_fetch_assoc($r)) 
           {
			...
			// print_r($privileges);
			 ...
			 {
			    if ($row["linkUrl"]=="#") $myclass= "dropmenu"; else $myclass = "internalLink moduleLink";
				echo "<a href=\"$row[linkUrl]\" id=\"$row[linkId]\" class=\"$myclass\">\r
