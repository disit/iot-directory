 ...
 function drawAttrJSON(attrJSON)
{
   ...
   for (var x=0; x<attrValue.length; x++){
		...
		div.innerHTML = ("<div class=\"row\" style=\"border:3px solid blue;\" ><div class=\"col-xs-6 col-md-3 modalCell\">" +
        "<div class=\"modalFieldCnt\"><input type=\"text\" class=\"modalInputTxt\""+
		"name=\"" +  attrJSON +  "\"  value=\"" + attrValue[x].value_name + "\">" + 
        "</div><div class=\"modalFieldLabelCnt\">Value Name</div></div>"+
		
		"<div class=\"row\" style=\"border:3px solid blue;\" ><div class=\"col-xs-6 col-md-3 modalCell\">" +
        "<div class=\"modalFieldCnt\"><input type=\"text\" class=\"modalInputTxt\""+
		"name=\"" +  attrJSON +  "\"  value=\"" + attrValue[x].data_type + "\">" + 
        "</div><div class=\"modalFieldLabelCnt\">Value Name</div></div>"+
		
		"<div class=\"row\" style=\"border:3px solid blue;\" ><div class=\"col-xs-6 col-md-3 modalCell\">" +
        "<div class=\"modalFieldCnt\"><input type=\"text\" class=\"modalInputTxt\""+
		"name=\"" +  attrJSON +  "\"  value=\"" + attrValue[x].value_type + "\">" + 
        "</div><div class=\"modalFieldLabelCnt\">Value Name</div></div>"+
		
		"<div class=\"row\" style=\"border:3px solid blue;\" ><div class=\"col-xs-6 col-md-3 modalCell\">" +
        "<div class=\"modalFieldCnt\"><input type=\"text\" class=\"modalInputTxt\""+
		"name=\"" +  attrJSON +  "\"  value=\"" + attrValue[x].value_unit + "\">" + 
        "</div><div class=\"modalFieldLabelCnt\">Value Name</div></div>"+
		
		"<div class=\"row\" style=\"border:3px solid blue;\" ><div class=\"col-xs-6 col-md-3 modalCell\">" +
        "<div class=\"modalFieldCnt\"><input type=\"text\" class=\"modalInputTxt\""+
		"name=\"" +  attrJSON +  "\"  value=\"" + attrValue[x].healthiness_criteria + "\">" + 
        "</div><div class=\"modalFieldLabelCnt\">Value Name</div></div>"+
		
		
		"<div class=\"row\" style=\"border:3px solid blue;\" ><div class=\"col-xs-6 col-md-3 modalCell\">" +
        "<div class=\"modalFieldCnt\"><input type=\"text\" class=\"modalInputTxt\""+
		"name=\"" +  attrJSON +  "\"  value=\"" + attrValue[x].healthiness_value + "\">" + 
        "</div><div class=\"modalFieldLabelCnt\">Value Name</div></div>"+

	    "</div></div>");
		
		addlistAttributes.appendChild(div);
  ...
  function updateDeviceTimeout()
	...
	$("#selectModelDevice").click(function() {
		...
		if (($("#selectModelDevice").value !=="customOption")&&($("#selectModelDevice").value !=="")) {
