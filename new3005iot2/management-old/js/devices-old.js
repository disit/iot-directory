                ...
                success: function (data)
                {
                    ...
                    $('#devicesTable').bootstrapTable({
                            ...
                            },
							{
                                ...
                                formatter: function(value, row, index)
                                {
                                    return '<div class="addMapBtn"><i  data-toggle="modal" data-target="#addMapShow" onclick="drawMap(\''+ row.latitude +"\',\'" + row.longitude + '\')\" class="fa fa-globe"  style=\"font-size:36px; color: #0000ff\"></i></div>';
                                },
                                cellStyle: function(value, row, index, field) {
                                    if(index%2 !== 0)
                                    {
