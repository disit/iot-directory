                ...
                success: function (data)
                {
                    ...
                    $('#devicesTable').bootstrapTable({
                            ...
                            },
							{
								...
								//return '<button type="button" id="active" class="btn btn-success"><span style="font-size:8px; color: green">ACTIVE</span></button>';
							...
							detailFormatter: function(index, row, element) {
                                var txt ="";
                                if (row.contextBroker=="orionUNIFI") txt = 'IoT BRoker URI: ' + ' http://iot-app.snap4city.org/orion-broker/';
                               return txt + ' | Kind: ' + data[index].kind   + ' | type: ' + data[index].type   + '| k1: ' + row.k1 +  '| k2: ' + row.k2 +  ' | MAC: ' + data[index].macaddress + ' | Model: ' + data[index].model + " | Producer: " + data[index].producer + " | Longitude: " + data[index].longitude + " | Latitude: " + data[index].latitude;
							},
						 ...
						 if(data["status"] === 'ko')
						 ...
						 else (data["status"] === 'ok')
							{
								...
								var attrJSON  = data.content.attributes;
									...
									drawAttrJSON(attrJSON);
								mynewAttributes = attrJSON;
